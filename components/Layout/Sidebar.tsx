...
export default function Sidebar({ activeModule, onModuleChange }: { activeModule: string, onModuleChange: (id: string) => void }) {
  return (
    <div className="w-16 md:w-64 h-screen bg-[#05070a] text-white border-r border-white/10 flex flex-col transition-all duration-300 overflow-hidden z-50">
      <div className="p-6 flex items-center gap-3">
        <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shrink-0 shadow-[0_0_20px_rgba(255,255,255,0.2)]">
          <span className="text-black font-black text-xl italic">W</span>
        </div>
        <div className="hidden md:block overflow-hidden">
          <h1 className="font-black text-sm tracking-tighter uppercase italic leading-none">WhisperX</h1>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-1 hidden md:block">
          <button className="w-full flex items-center gap-3 px-3 py-2 text-[10px] font-bold uppercase tracking-widest text-white/20 hover:text-white transition-colors">
        ...
        <div className="p-3 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-md">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-purple-500 border border-white/20 shadow-lg shrink-0" />
            <div className="hidden md:block overflow-hidden">
              <p className="text-[10px] font-black uppercase tracking-widest truncate">Arty69x</p>
